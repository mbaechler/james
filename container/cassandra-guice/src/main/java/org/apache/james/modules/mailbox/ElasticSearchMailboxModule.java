...
public class ElasticSearchMailboxModule extends AbstractModule {
    ...
    private final Provider<ClientProvider> provider;

    public ElasticSearchMailboxModule(Provider<ClientProvider> clientProviderProvider) {
        this.provider = clientProviderProvider;
    }

    public ElasticSearchMailboxModule() {
        this.provider = this::provideClientProviderDefault;
    }
    ...
    @Provides
    @Singleton
    public ClientProvider provideClientProvider() {
        return provider.get();
    }

    protected ClientProvider provideClientProviderDefault() {
