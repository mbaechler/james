...
public class SMTPServerModule extends AbstractModule {
    ...
    @Provides
    @Singleton
    private SMTPServerFactory smtpServerFactory(@Named(ProtocolHandlerLoader.COMPONENT_NAME) ProtocolHandlerLoader loader,
                                                @Named(FileSystem.COMPONENT_NAME)FileSystem fileSystem,
                                                @Named(DNSService.COMPONENT_NAME)DNSService dnsService) {
        SMTPServerFactory smtpServerFactory = new SMTPServerFactory();
        smtpServerFactory.setLog(LOGGER);
        smtpServerFactory.setFileSystem(fileSystem);
        smtpServerFactory.setDnsService(dnsService);
        smtpServerFactory.setProtocolHandlerLoader(loader);
