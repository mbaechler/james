...
public class ActiveMQQueueModule extends AbstractModule {
    ...
    @Singleton
    @Inject
    @Named(ActiveMQMailQueueFactory.JMS_CONNECTION_COMPONENT_NAME)
    ...
    @Provides
    @Singleton
    @Named(MailQueueFactory.COMPONENT_NAME)
    public MailQueueFactory createActiveMailQueueFactory(@Named(ActiveMQMailQueueFactory.JMS_CONNECTION_COMPONENT_NAME) ConnectionFactory connectionFactory) {
