...
public class CassandraDataModule extends AbstractModule {
    ...
    protected void configure() {
        bind(DomainList.class).annotatedWith(Names.named(DomainList.COMPONENT_NAME)).to(CassandraDomainList.class);
        bind(UsersRepository.class).annotatedWith(Names.named(UsersRepository.COMPONENT_NAME)).to(CassandraUsersRepository.class);
        bind(RecipientRewriteTable.class).annotatedWith(Names.named(RecipientRewriteTable.COMPONENT_NAME)).to(XMLRecipientRewriteTable.class);
