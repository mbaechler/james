...
public class CassandraJamesServerTest {
    ...
    private static final CassandraClusterSingleton CASSANDRA = CassandraClusterSingleton.create(new CassandraDataModelComposite(new CassandraMailboxDataModel(), new CassandraDataDataModel()));
