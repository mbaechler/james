...
public class RecipientRewriteTable extends AbstractRecipientRewriteTableMailet {
     ...
     */
    @Inject
    public final void setRecipientRewriteTable(@Named(org.apache.james.rrt.api.RecipientRewriteTable.COMPONENT_NAME) org.apache.james.rrt.api.RecipientRewriteTable vut) {
        this.vut = vut;
    }
