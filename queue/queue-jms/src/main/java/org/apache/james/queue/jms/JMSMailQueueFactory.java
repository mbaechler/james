...
public class JMSMailQueueFactory extends AbstractMailQueueFactory {
    ...
    public static final String JMS_CONNECTION_COMPONENT_NAME = "jmsConnectionFactory";

    protected ConnectionFactory connectionFactory;

    @Inject
    public void setConnectionFactory(@Named(JMS_CONNECTION_COMPONENT_NAME) ConnectionFactory connectionFactory) {
